...
void auto0R() { //heil hitler bigga
  Flywheel.move(-120);
  chassis.set_turn_pid(-5, 50);
  chassis.wait_drive();
  //turn(355, 1, 127);
  pros::delay(4000);
  Hood.set_value(false);
  DiskIntake.move_relative(380, 2000);

  pros::delay(1000);
  Flywheel.move(-120);
  pros::delay(2000);
  DiskIntake.move_relative(20000, 2000);

  pros::delay(700);
  Flywheel.move(0);
  optical.set_led_pwm(100);
  while (optical.get_hue() < 100.0) {
          DiskIntake.move(127);
...
void auto1R() {
  ...
  chassis.wait_drive();
  pros::delay(100);
  chassis.set_turn_pid(108, 80);
  chassis.wait_drive();
  pros::delay(3000);
  Hood.set_value(false);
  DiskIntake.move_relative(383, 2000);
